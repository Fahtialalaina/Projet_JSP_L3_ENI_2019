...
<div class="right_col" role="main">
            ...
            <div class="title_right">
                <div class="col-md-4 col-sm-4 col-xs-12 form-group pull-right top_search">
                  <div class="input-group">
                      <a href='../crud/ajoutretrait.jsp'><button type="button" class="btn btn-primary btn-sm"><i class="fa fa-plus" aria-hidden="true"></i> Ajouter</button></a>
        ...
        String data = "SELECT * FROM retrait INNER JOIN client ON retrait.cb = client.cb ORDER BY idr DESC";
    %>
                        ...
                        <thead>
                          <tr>
                                ...
                                <tbody>
                                    ...
                                    %>
                                    <tr>
                                        <td><%=res.getString("nr")%></td>
                                        <td><%=res.getString("retrait.cb")%></td>
                                        <td><%=res.getString("nom")%></td>
                                        <td><%=res.getString("montant")%></td>
                                        <td><%=res.getString("solde")%></td>
                                        <td><%=res.getString("date")%></td>
                                        <td style="text-align: center;">
                                            <a href='../crud/modifieretrait.jsp?u=<%=res.getString("idr")%>'><button type="button" class="btn btn-success btn-xs"><i class="fa fa-edit" aria-hidden="true"></i> Modifier</button></a>
                                            <a href='../crud/supretrait.jsp?d=<%=res.getString("idr")%>'><button type="button" class="btn btn-dark btn-xs"><i class="fa fa-trash" aria-hidden="true"></i> Supprimer</button></a>
                                        </td>
                                    </tr>
                                    <%
                                    }
